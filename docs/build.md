...
by yourself or using our docker images which provides several linux distro 
support.
...
| ---                     | ---     | ---                    | ---          | ---                   | ---                      | ---                                                                                 |
| `latest`                | x86\_64 | Ubuntu 21.04           | 12.0.0       | CC=gcc, CXX=g++       | Ubuntu 21.04+            | This is for CI, will always use the latest Ubuntu release                           |
